...
GOLDEN_SUITES: dict[str, dict[str, list[str]]] = {
    "golden": {
        ...
        "pytest": [
            "tests/test_alert_dispatch_parity.py",
            "tests/test_alert_dedupe_key.py",
            "tests/test_alert_peek_lease.py",
            "tests/test_alert_policy.py",
            "tests/test_alert_piper_gate.py",
            "tests/test_alert_poll_race.py",
            "tests/test_alert_priority_speak.py",
            "tests/test_alert_shadow.py",
            "tests/test_alert_shadow_report.py",
            "tests/test_alerts_spoken_ledger.py",
            "tests/test_miss_ledger.py",
            "tests/test_alert_speak_gate.py",
            "tests/test_alert_speaker_choke.py",
            "tests/test_alert_store.py",
            "tests/test_alert_store_factory.py",
            "tests/test_alert_store_gate.py",
            ...
            "tests/test_self_monitor_result.py",
            "tests/test_settings.py",
            "tests/test_settings_alert_keys.py",
        ...
        "py_compile": [
            ...
            "src/jarvis/aec.py",
            "src/jarvis/alert_dispatch.py",
            "src/jarvis/alert_policy.py",
            "src/jarvis/alert_shadow.py",
    ...
    "regression": {
        ...
        "pytest": [
            ...
            "tests/test_settings_ui_preserve.py",
